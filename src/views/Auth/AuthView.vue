...
<template>
    <div class="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
        ...
        <form class="space-y-6" action="#" method="POST" @submit.prevent="handleClick">
            ...
            <div class="mt-2">
                <input id="email" v-model="form.email" name="email" type="email" autocomplete="email" required class="block w-full text-white rounded-md border-0 py-1.5 shadow-sm ring-gray-700 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 bg-gray-700" />
            </div>
            </div>
            ...
            <div class="mt-2">
                <input id="password" v-model="form.password" name="password" type="password" autocomplete="current-password" required class="block w-full rounded-md border-0 py-1.5 text-white shadow-sm ring-gray-700 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 bg-gray-700" />
            </div>
